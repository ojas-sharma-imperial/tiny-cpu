...
VL_INLINE_OPT void Vdut___024root___combo__TOP__0(Vdut___024root* vlSelf) {
    ...
    } else if ((IData)((0xc0U == (0xc1U & (IData)(vlSelf->testing__DOT__ui_in))))) {
        vlSelf->testing__DOT__main_cpu__DOT__main_cpu__DOT__main_datapath__DOT__op2sel 
            = (1U & (~ ((IData)(vlSelf->testing__DOT__ui_in) 
                        >> 2U)));
    }
...
VL_INLINE_OPT void Vdut___024root___combo__TOP__1(Vdut___024root* vlSelf) {
    ...
    if ((4U & (IData)(vlSelf->testing__DOT__ui_in))) {
        ...
        vlSelf->testing__DOT__main_cpu__DOT__main_cpu__DOT__main_datapath__DOT__aludout 
            = (0xfU & ((2U & (IData)(vlSelf->testing__DOT__ui_in))
                        ? ((1U & (IData)(vlSelf->testing__DOT__ui_in))
...
VL_INLINE_OPT void Vdut___024root___combo__TOP__2(Vdut___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vdut__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdut___024root___combo__TOP__2\n"); );
    // Body
...
void Vdut___024root___eval(Vdut___024root* vlSelf) {
    ...
    Vdut___024root___combo__TOP__2(vlSelf);
    // Final
...
VL_INLINE_OPT QData Vdut___024root___change_request_1(Vdut___024root* vlSelf) {
    ...
    __req |= ((vlSelf->testing__DOT__ui_in ^ vlSelf->__Vchglast__TOP__testing__DOT__ui_in)
         | (vlSelf->testing__DOT__main_cpu__DOT__main_cpu__DOT__main_datapath__DOT__main_alu__DOT__addsubdout ^ vlSelf->__Vchglast__TOP__testing__DOT__main_cpu__DOT__main_cpu__DOT__main_datapath__DOT__main_alu__DOT__addsubdout));
    VL_DEBUG_IF( if(__req && ((vlSelf->testing__DOT__ui_in ^ vlSelf->__Vchglast__TOP__testing__DOT__ui_in))) VL_DBG_MSGF("        CHANGE: testing.sv:10: testing.ui_in\n"); );
    VL_DEBUG_IF( if(__req && ((vlSelf->testing__DOT__main_cpu__DOT__main_cpu__DOT__main_datapath__DOT__main_alu__DOT__addsubdout ^ vlSelf->__Vchglast__TOP__testing__DOT__main_cpu__DOT__main_cpu__DOT__main_datapath__DOT__main_alu__DOT__addsubdout))) VL_DBG_MSGF("        CHANGE: alu4.sv:171: testing.main_cpu.main_cpu.main_datapath.main_alu.addsubdout\n"); );
    // Final
    vlSelf->__Vchglast__TOP__testing__DOT__ui_in = vlSelf->testing__DOT__ui_in;
    vlSelf->__Vchglast__TOP__testing__DOT__main_cpu__DOT__main_cpu__DOT__main_datapath__DOT__main_alu__DOT__addsubdout 
        = vlSelf->testing__DOT__main_cpu__DOT__main_cpu__DOT__main_datapath__DOT__main_alu__DOT__addsubdout;
    return __req;
}
